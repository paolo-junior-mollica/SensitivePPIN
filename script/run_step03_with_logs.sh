...
RUN_ID="step03_${RUN_TIMESTAMP}"
RUNS_DIR="${RUNS_DIR:-drug_disease_validation/run_logs/step03_runs}"
RUN_DIR="${RUNS_DIR}/${RUN_ID}"
LOG_FILE="${RUN_DIR}/step03.log"
...
COMMAND=(
  ...
  "${PYTHON_BIN}"
  -m
  drug_disease_validation.src.03_find_pathways
  "$@"
)
...
echo "[${RUN_ID}] starting Step 3 run"
