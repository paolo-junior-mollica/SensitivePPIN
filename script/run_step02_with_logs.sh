...
RUN_ID="step02_${RUN_TIMESTAMP}"
RUNS_DIR="${RUNS_DIR:-drug_disease_validation/run_logs/step02_runs}"
RUN_DIR="${RUNS_DIR}/${RUN_ID}"
LOG_FILE="${RUN_DIR}/step02.log"
...
COMMAND=(
  ...
  "${PYTHON_BIN}"
  -m
  drug_disease_validation.src.02_build_pairs
  "$@"
)
...
echo "[${RUN_ID}] starting Step 2 run"
