...
RUN_ID="step01_${RUN_TIMESTAMP}"
RUNS_DIR="${RUNS_DIR:-drug_disease_validation/run_logs/step01_runs}"
RUN_DIR="${RUNS_DIR}/${RUN_ID}"
LOG_FILE="${RUN_DIR}/step01.log"
...
COMMAND=(
  ...
  "${PYTHON_BIN}"
  -m
  drug_disease_validation.src.01_download_data
  --disgenet-file
  drug_disease_validation/data/raw/curated_gene_disease_associations.tsv.gz
  "$@"
)
...
echo "[${RUN_ID}] starting Step 1 run"
